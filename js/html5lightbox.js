...
function loadHtml5LightBox(jsFolder) {
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            var l;
            var mark = "";
            var bytes = inst.options.fullmark.split(",");
            for (i = 0; i < bytes.length; i++) mark += String.fromCharCode(bytes[i]);
            inst.options.fullmark = mark;
            ...
            if (inst.options.initvimeo) {
                ...
                tag.src = "https://www.um.edu.mo/35th_anniversary/js/froogaloop2.min.js";
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.fullscreenmode) {
                    ...
                    inst.$lightbox.append("<div class='html5-next-fullscreen' style='cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" +
                        inst.options.fullscreennextimage + "'></div>" + "<div class='html5-prev-fullscreen' style='cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.fullscreenprevimage + "'></div>");
                    ...
                    inst.$lightboxBox.append("<div class='html5-next-bottom-fullscreen' style='cursor:pointer;position:absolute;top:100%;right:0;margin-top:8px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" +
                        inst.options.fullscreennextimage + "'></div>" + "<div class='html5-prev-bottom-fullscreen' style='cursor:pointer;position:absolute;top:100%;left:0;margin-top:8px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.fullscreenprevimage + "'></div>");
                    ...
                    inst.$elemWrap.append("<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.nextimage +
                        "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.previmage + "'></div>");
                    ...
                    if (inst.options.isTouch && inst.options.navarrowsalwaysshowontouch || inst.options.alwaysshownavarrows) {
                        ...
                        inst.$lightboxBox.append("<div class='html5-next-touch' style='display:block;cursor:pointer;position:absolute;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" +
                            inst.options.nextimage + "'></div>" + "<div class='html5-prev-touch' style='display:block;cursor:pointer;position:absolute;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.previmage + "'></div>");
                    ...
                    inst.$lightboxBox.append("<div id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/lightbox-close.png'></div>");
                    inst.$close = $("#html5-close", inst.$lightbox)
                }
                inst.$watermark = $("#html5-watermark", inst.$lightbox);
                if (inst.options.stamp) inst.$watermark.html("<a href='" + inst.options.fulllink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='display:block;width:170px;height:20px;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:;color:#333;font:0px Arial,sans-serif;'><div style='line-height:20px;'>" +
                    inst.options.fullmark + "</div></div></a>");
            ...
            inst.slideTimer = function(interval, callback, updatecallback) {
                ...
                this.start = function() {
                    ...
                    updateTimerId = setInterval(function() {
                        ...
                        if (runningTime >
                            timerInstance.timeout) { clearInterval(updateTimerId); if (callback) callback() }
            ...
            inst.initSlide = function() {
                ...
                inst.slideTimeout = inst.slideTimer(inst.options.slideinterval,
                    function() { inst.gotoSlide(-1) }, inst.options.showtimer ? function(percent) { inst.updateTimer(percent) } : null);
            ...
            inst.showNavigation = function() {
                ...
                $("body").append("<div class='html5-nav' style='display:block;position:fixed;bottom:0;left:0;width:100%;height:" + inst.options.navheight + "px;z-index:9999999;'>" + "<div class='html5-nav-container' style='position:relative;margin:" +
                    ...
                    inst.options.thumbtopmargin + "px auto " + inst.options.thumbbottommargin + "px;'>" + "<div class='html5-nav-prev' style='display:block;position:absolute;cursor:pointer;width:" + inst.options.navbuttonwidth + 'px;height:100%;left:0;top:0;background:url("https://www.um.edu.mo/35th_anniversary/js/skins/default/' + inst.options.navarrowsprevimage + "\") no-repeat left center;'></div>" + "<div class='html5-nav-mask' style='display:block;position:relative;margin:0 auto;overflow:hidden;'>" + "<div class='html5-nav-list'></div>" + "</div>" + "<div class='html5-nav-next' style='display:block;position:absolute;cursor:pointer;width:" +
                    inst.options.navbuttonwidth + 'px;height:100%;right:0;top:0;background:url("https://www.um.edu.mo/35th_anniversary/js/skins/default/' + inst.options.navarrowsnextimage + "\") no-repeat right center;'></div>" + "</div>" + "</div>");
                var index = 0;
                for (i = 0; i < inst.elemArray.length; i++)
            ...
            inst.showTitle = function(w, t, description) {
                ...
                if (inst.options.inGroup) {
                    ...
                    if (inst.options.showplaybutton) text = "<div id='html5-playpause' style='display:inline-block;cursor:pointer;vertical-align:middle;'><div id='html5-play' style='display:block;'><img src='https://www.um.edu.mo/35th_anniversary/js/skins/default/lightbox-play.png'></div><div id='html5-pause' style='display:none;'><img src='" + "https://www.um.edu.mo/35th_anniversary/js/skins/default/" + inst.options.pauseimage + "'></div></div> " + text
                }
            ...
            inst.loadNext = function() { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1) };
            inst.getYoutubeParams = function(href) {
                var result = {};
                if (href.indexOf("?") < 0) return result;
                var params = href.substring(href.indexOf("?") + 1).split("&");
                for (var i =
                        0; i < params.length; i++) { var value = params[i].split("="); if (value && value.length == 2 && value[0].toLowerCase() != "v") result[value[0].toLowerCase()] = value[1] }
                return result
            };
            ...
            inst.showYoutubeVimeo = function(elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function() {
                    ...
                    inst.$elem.show();
                    inst.showData();
                    if (elem[ELEM_TYPE] == 3 && typeof YT === "object" && typeof YT.Player === "function") new YT.Player("html5boxiframevideo", { events: { "onStateChange": function(event) { if (event.data == YT.PlayerState.ENDED) { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1) } } } });
            ...
            inst.resizeLightbox = function(elemW,
                ...
                if (inst.options.titlestyle == "left" || inst.options.titlestyle == "right") {
                    ...
                    inst.$lightboxBox.animate({ width: boxW }, speed).animate({ height: boxH }, speed, function() { inst.onAnimateFinish(onFinish) })
                } else {
                    var speed = bAnimate ? inst.options.resizespeed : 0;
            ...
            inst.embedHTML5Video = function($container, src, autoplay) {
                $container.html("<div style='display:block;width:100%;height:100%;position:relative;'><video id='html5-lightbox-video' width='100%' height='100%'" +
                    (inst.options.html5videoposter && inst.options.html5videoposter.length > 0 ? "poster='" + inst.options.html5videoposter + "'" : "") + (autoplay ? " autoplay" : "") + (inst.options.nativehtml5controls && !inst.options.videohidecontrols ? " controls='controls'" : "") + " src='" + src + "'></div>");
                ...
                $("video", $container).unbind("ended").bind("ended",
                    function() { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1) })
            };
            ...
            inst.addItem = function(href, title, group, width, height, webm, ogg, thumbnail,
                description) {
        ...
        $.fn.lightboxHTML5VideoControls = function(skinFolder,
            ...
            if (!isIPhone) {
                ...
                $videoPlay.css({
                    ...
                    "background-image": "url('" + "https://www.um.edu.mo/35th_anniversary/js/skins/default/" +
            ...
            $videoObj.bind(eClick, function() { userActive = true }).hover(function() { userActive = true }, function() {
                userActive =
                    false
            });
            ...
            //     function() { $(this).css({ "background-position": "top left" }) }).bind(eClick, function() { $videoObj.get(0).play() });
            ...
            $videoBtnPlay.css({ display: "block", position: "absolute", top: 0, left: 0, width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", cursor: "pointer", "background-image": "url('" + 'https://www.um.edu.mo/35th_anniversary/js/skins/default/' + "html5boxplayer_playpause.png" + "')", "background-position": "top left" }).hover(function() { $(this).css({ "background-position": "bottom left" }) },
                function() { $(this).css({ "background-position": "top left" }) }).bind(eClick, function() { $videoObj.get(0).play() });
            $videoBtnPause.css({ display: "none", position: "absolute", top: 0, left: 0, width: BUTTON_SIZE + "px", height: BUTTON_SIZE + "px", cursor: "pointer", "background-image": "url('" + 'https://www.um.edu.mo/35th_anniversary/js/skins/default/' + "html5boxplayer_playpause.png" + "')", "background-position": "top right" }).hover(function() { $(this).css({ "background-position": "bottom right" }) }, function() { $(this).css({ "background-position": "top right" }) }).bind(eClick, function() { $videoObj.get(0).pause() });
            ...
            if (!isIPhone && ($videoObj.get(0).requestFullscreen || $videoObj.get(0).webkitRequestFullScreen || $videoObj.get(0).mozRequestFullScreen || $videoObj.get(0).webkitEnterFullScreen || $videoObj.get(0).msRequestFullscreen)) {
                ...
                $videoFullscreen.css({
                    ...
                    "background-image": "url('" + "https://www.um.edu.mo/35th_anniversary/js/skins/default/" + "html5boxplayer_fullscreen.png" + "')",
            ...
            if (hd) {
                ...
                $videoHD.css({
                    ...
                    "background-image": "url('" +
                        "https://www.um.edu.mo/35th_anniversary/js/skins/default/" + "html5boxplayer_hd.png" + "')",
            ...
            if ($videoObj.get(0).volume === volume / 2 + 0.1) {
                ...
                $videoVolumeButton.css({
                    ...
                    "background-image": "url('" + "https://www.um.edu.mo/35th_anniversary/js/skins/default/" + "html5boxplayer_volume.png" + "')",
